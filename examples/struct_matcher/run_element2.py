...
for i in range(len(sym_st)):
    ...
    rep_pos, sorted_elements, recommend_order = irrep_pos.irrep_positions(axis, pos, elements)
...
for i in range(len(nondup_st)):
    ...
    for symprec in nondup_st[i]["recommend_order"]:
        ...
        _rep_pos, sorted_elements, recommend_order = irrep_pos.irrep_positions(axis, pos, elements)
