...
```shell
python ./elemental/gen_single_model.py --model_type 2
python ./elemental/gen_single_model.py --model_type 3
python ./elemental/gen_single_model.py --model_type 4
python ./elemental/gen_single_model.py --model_type pair
```

Generating model parameter candidates of hybrid polynomial MLPs.
```shell
python ./elemental/gen_hybrid_model.py --model_type 2
python ./elemental/gen_hybrid_model.py --model_type 4
```
